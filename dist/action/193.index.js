...
var tokenProviders = __webpack_require__(37376);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(90668); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(19693);
...
var nodeHttpHandler = __webpack_require__(71745);
var protocols$1 = __webpack_require__(78206);
