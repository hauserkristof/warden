 ...
 */
export declare function anthropicUsageToStats(model: string, usage: AnthropicApiUsage): UsageStats;
/** @deprecated Use anthropicUsageToStats. */
export declare const apiUsageToStats: typeof anthropicUsageToStats;
