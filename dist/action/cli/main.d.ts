...
type SkillRunnerOptionOverrides = Pick<SkillRunnerOptions, 'model' | 'maxTurns' | 'effort' | 'runtime' | 'providers' | 'auxiliaryModel' | 'synthesisModel' | 'auxiliaryMaxRetries' | 'verifyFindings'>;
 ...
 */
export declare function verifyCustomProviderAuthForRun(items: {
    runtime?: SkillRunnerOptions['runtime'];
    providers?: SkillRunnerOptions['providers'];
}[], reporter: Reporter, env?: NodeJS.ProcessEnv): boolean;
 ...
 */
export declare function resolveCliDefaultAuxiliaryModel(config: Pick<WardenConfig, 'defaults'> | null | undefined, cliModel?: string): string | undefined;
/** Resolve the default synthesis model, falling back to the auxiliary lane when unset. */
export declare function resolveCliDefaultSynthesisModel(config: Pick<WardenConfig, 'defaults'> | null | undefined, cliModel?: string): string | undefined;
...
export declare function resolveCliEffort(config: Pick<WardenConfig, 'defaults'> | null | undefined, cliEffort?: Effort): Effort | undefined;
/**
