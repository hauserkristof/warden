...
async function evaluateFix(input, context, apiKey, runtimeOptionsOrMaxRetries) {
    ...
    const result = await (0,runtimes/* getRuntime */.fr)(runtime).runAuxiliary({
        task: 'fix_evaluation',
        ...
        providerOptions: (0,runtimes/* getRuntimeProviderOptions */.g_)(runtime, { providers: runtimeOptions.providers }),
    });
    if (result.success) {
...
/* harmony import */ var _sdk_runtimes_custom_provider_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(25831);
...
async function executeTrigger(trigger, deps) {
    return _sentry_js__WEBPACK_IMPORTED_MODULE_0__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'trigger.execute', name: `execute ${trigger.name}` }, async (span) => {
        ...
        try {
            ...
            (0,_sdk_runtimes_custom_provider_js__WEBPACK_IMPORTED_MODULE_9__/* .assertCustomProviderAuthForRuntime */ .mN)(trigger.runtime, trigger.providers, process.env);
            const taskOptions = {
                name: trigger.name,
...
/* harmony export */ });
/* unused harmony export resolveWorkflowAuxiliaryOptions */
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73024);
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(node_fs__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _config_model_lanes_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22585);
/* harmony import */ var _event_context_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(58147);
/* harmony import */ var _triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(49431);
/* harmony import */ var _output_dedup_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3941);
/* harmony import */ var _output_stale_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(95768);
...
/* harmony import */ var _sdk_runtimes_index_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(23473);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(53537);
/* harmony import */ var _output_renderer_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(21242);
/* harmony import */ var _reporting_output_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(80961);
...
function resolveWorkflowAuxiliaryOptions(layered) {
    ...
    return {
        ...
        model: (0,_config_model_lanes_js__WEBPACK_IMPORTED_MODULE_4__/* .resolveAuxiliaryLaneModel */ .Wy)((0,_config_loader_js__WEBPACK_IMPORTED_MODULE_3__/* .emptyToUndefined */ .Zu)(baseDefaults?.auxiliary?.model) ??
            (0,_config_loader_js__WEBPACK_IMPORTED_MODULE_3__/* .emptyToUndefined */ .Zu)(repoDefaults?.auxiliary?.model), (0,_config_loader_js__WEBPACK_IMPORTED_MODULE_3__/* .emptyToUndefined */ .Zu)(baseDefaults?.agent?.model) ??
            (0,_config_loader_js__WEBPACK_IMPORTED_MODULE_3__/* .emptyToUndefined */ .Zu)(baseDefaults?.model) ??
            (0,_config_loader_js__WEBPACK_IMPORTED_MODULE_3__/* .emptyToUndefined */ .Zu)(repoDefaults?.agent?.model) ??
            (0,_config_loader_js__WEBPACK_IMPORTED_MODULE_3__/* .emptyToUndefined */ .Zu)(repoDefaults?.model)),
...
function logFixEvaluation(ev, index, total) {
    ...
    const costStr = ev.usage.costUSD > 0 ? `, ${(0,_cli_output_formatters_js__WEBPACK_IMPORTED_MODULE_12__/* .formatCost */ .BD)(ev.usage.costUSD)}` : '';
...
async function setupGitHubState(octokit, context) {
    ...
    try {
        const coreCheck = await (0,_checks_manager_js__WEBPACK_IMPORTED_MODULE_19__/* .createCoreCheck */ .c)(octokit, {
            owner: context.repository.owner,
            repo: context.repository.name,
            headSha: context.pullRequest.headSha,
        });
 ...
 */
async function postReviewsAndTrackFailures(octokit, context, results, inputs, auxiliaryOptions, options = {}) {
    ...
    if (context.pullRequest) {
        try {
            ...
            if (fetchedComments.length > 0) {
                ...
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Found ${fetchedComments.length} existing comments for deduplication (${wardenCount} Warden${externalNote})`);
            }
        }
        catch (error) {
    ...
    for (const result of results) {
        if (result.report) {
            ...
            const reportForFail = { ...result.report, findings: (0,_types_index_js__WEBPACK_IMPORTED_MODULE_9__/* .filterFindings */ .Ni)(result.report.findings, undefined, result.minConfidence) };
            if (failCheck && result.failOn && (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__/* .shouldFail */ .W9)(reportForFail, result.failOn)) {
                shouldFailAction = true;
                const count = (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__/* .countFindingsAtOrAbove */ .tH)(reportForFail, result.failOn);
 ...
 */
async function evaluateFixesAndResolveStale(octokit, context, fetchedComments, allFindings, activeWardenCommentIds, canResolveStale, anthropicApiKey, auxiliaryOptions, options = {}) {
    ...
    if (context.pullRequest &&
        ...
        try {
            ...
            for (const [commentBaseSha, groupComments] of commentsByOriginalCommit) {
                groupResults.push(await (0,_fix_evaluation_index_js__WEBPACK_IMPORTED_MODULE_11__/* .evaluateFixAttempts */ .Z)(octokit, groupComments, {
                    owner: context.repository.owner,
                    repo: context.repository.name,
            ...
            if (fixEvaluation.toResolve.length > 0) {
                const { resolvedCount, resolvedIds } = await (0,_output_stale_js__WEBPACK_IMPORTED_MODULE_8__/* .resolveStaleComments */ .AG)(octokit, fixEvaluation.toResolve, { failOnError: options.failOnWriteError }).catch((error) => {
            ...
            for (const reply of fixEvaluation.toReply) {
                ...
                if (reply.comment.threadId) {
                    try {
                        await (0,_fix_evaluation_index_js__WEBPACK_IMPORTED_MODULE_11__/* .postThreadReply */ .l)(octokit, reply.comment.threadId, reply.replyBody);
                    }
                    catch (error) {
    ...
    if (context.pullRequest && wardenComments.length > 0 && canResolveStale) {
        try {
            const scope = (0,_output_stale_js__WEBPACK_IMPORTED_MODULE_8__/* .buildAnalyzedScope */ .B8)(context.pullRequest.files);
            ...
            const staleComments = (0,_output_stale_js__WEBPACK_IMPORTED_MODULE_8__/* .findStaleComments */ .t8)(commentsForStaleCheck, allFindings, scope);
            if (staleComments.length > 0) {
                const { resolvedCount, resolvedIds } = await (0,_output_stale_js__WEBPACK_IMPORTED_MODULE_8__/* .resolveStaleComments */ .AG)(octokit, staleComments, { failOnError: options.failOnWriteError }).catch((error) => {
                    if (options.failOnWriteError) {
 ...
 */
async function dismissPreviousReviewIfResolved(octokit, context, previousReviewInfo, results, canResolveStale, options = {}) {
    ...
    const wouldRequestChanges = results.some((r) => {
        if (!r.failOn || r.failOn === 'off' || !(r.requestChanges ?? false) || !r.report)
            return false;
        const filtered = { ...r.report, findings: (0,_types_index_js__WEBPACK_IMPORTED_MODULE_9__/* .filterFindings */ .Ni)(r.report.findings, undefined, r.minConfidence) };
        return (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__/* .shouldFail */ .W9)(filtered, r.failOn);
    });
...
async function finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reports, findingObservations, shouldFailAction, failureReasons, canResolveStale, triggerErrors) {
    ...
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_20__/* .writeFindingsOutput */ .JR)(reports, context, findingObservations, {
    ...
    if (coreCheckId && context.pullRequest) {
        try {
            ...
            await (0,_checks_manager_js__WEBPACK_IMPORTED_MODULE_19__/* .updateCoreCheck */ .R2)(octokit, coreCheckId, summaryData, coreConclusion, {
                owner: context.repository.owner,
                repo: context.repository.name,
            });
        }
...
async function runAnalyzeMode(inputs, initResult, span) {
    ...
    if (skipCoreCheck || matchedTriggers.length === 0) {
        ...
        try {
            const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_20__/* .writeFindingsOutput */ .JR)([], context, [], { triggerResults: [] });
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${findingsPath}`);
        }
        catch (error) {
    ...
    await _sdk_runtimes_index_js__WEBPACK_IMPORTED_MODULE_16__/* .defaultMcpConnectionManager */ .V8.dispose();
...
async function runReportMode(octokit, inputs, initResult, repoPath, span) {
    ...
    try {
        ...
        if (matchedTriggers.length === 0) {
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_20__/* .setWorkflowOutputs */ .wZ)(outputs);
            try {
                const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_20__/* .writeFindingsOutput */ .JR)([], context, cleanupFindingObservations, {
                    triggerResults: [],
                });
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .logAction */ .d5)(`Findings written to ${findingsPath}`);
            }
        ...
        await _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'workflow.resolve', name: 'resolve stale comments' }, async (resolveSpan) => {
            const resolutionResult = await evaluateFixesAndResolveStale(octokit, context, reviewPhase.fetchedComments, allFindings, reviewPhase.activeWardenCommentIds, canResolveStale, inputs.anthropicApiKey, auxiliaryOptions, { failOnWriteError: true });
...
async function runPRWorkflow(octokit, inputs, eventName, eventPath, repoPath) {
    return _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'workflow.run', name: 'review pull_request' }, async (span) => {
        ...
        if (skipCoreCheck) {
            ...
            try {
                (0,_base_js__WEBPACK_IMPORTED_MODULE_20__/* .writeFindingsOutput */ .JR)([], context);
            }
            catch (error) {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6)(`Failed to write findings output: ${error}`);
            }
        ...
        if (matchedTriggers.length === 0) {
            await runOrFailCore(octokit, context, coreCheckId, async () => {
                ...
                try {
                    (0,_base_js__WEBPACK_IMPORTED_MODULE_20__/* .writeFindingsOutput */ .JR)([], context, cleanupFindingObservations);
                }
                catch (error) {
                    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_23__/* .warnAction */ .T6)(`Failed to write findings output: ${error}`);
                }
...
/* harmony import */ var _sdk_runtimes_custom_provider_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(25831);
/* harmony import */ var _output_github_issues_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(67034);
/* harmony import */ var _triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(49431);
/* harmony import */ var _skills_loader_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34691);
/* harmony import */ var _types_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(78481);
/* harmony import */ var _sentry_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(30340);
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(53537);
...
async function runScheduleWorkflow(octokit, inputs, repoPath) {
    return _sentry_js__WEBPACK_IMPORTED_MODULE_9__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'workflow.run', name: 'review schedule' }, (span) => runScheduleWorkflowInner(octokit, inputs, repoPath, span));
}
async function runScheduleWorkflowInner(octokit, inputs, repoPath, workflowSpan) {
    const githubRepository = process.env['GITHUB_REPOSITORY'];
    (0,_sentry_js__WEBPACK_IMPORTED_MODULE_9__/* .setRepositoryScope */ .vx)(githubRepository);
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .logGroup */ .QT)('Loading configuration');
    if (inputs.baseConfigPath) {
        console.log(`Base config path: ${inputs.baseConfigPath}`);
    }
    if (inputs.baseSkillRoot) {
    ...
    console.log(`Repo config path: ${inputs.configPath}`);
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .logGroupEnd */ .TN)();
    ...
    try {
        ...
        if (error instanceof _config_loader_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfigLoadError */ .tx &&
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('findings-count', 0);
            (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('high-count', 0);
            (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('summary', 'No warden.toml found');
            try {
                ...
                (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .writeFindingsOutput */ .JR)([], {
                    eventType: 'schedule',
                    action: 'scheduled',
    ...
    (0,_sentry_js__WEBPACK_IMPORTED_MODULE_9__/* .emitRunMetric */ .LW)();
    const traceId = workflowSpan.spanContext?.().traceId;
    _sentry_js__WEBPACK_IMPORTED_MODULE_9__/* .logger */ .vF.info('Workflow initialized', {
    ...
    if (scheduleTriggers.length === 0) {
        ...
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('findings-count', 0);
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('high-count', 0);
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('summary', 'No schedule triggers configured');
        workflowSpan.setAttribute('warden.finding.count', 0);
        try {
            const fullName = process.env['GITHUB_REPOSITORY'] ?? '';
            const [o = '', n = ''] = fullName.split('/');
    ...
    if (!githubRepository) {
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setFailed */ .C1)('GITHUB_REPOSITORY environment variable not set');
    }
    const [owner, repo] = githubRepository.split('/');
    if (!owner || !repo) {
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setFailed */ .C1)('Invalid GITHUB_REPOSITORY format');
    }
    const headSha = process.env['GITHUB_SHA'] ?? '';
    if (!headSha) {
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setFailed */ .C1)('GITHUB_SHA environment variable not set');
    }
    const defaultBranch = await (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .getDefaultBranchFromAPI */ .YL)(octokit, owner, repo);
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .logGroup */ .QT)('Processing schedule triggers');
    ...
    for (const resolved of scheduleTriggers) {
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .logGroup */ .QT)(`Running trigger: ${resolved.name} (skill: ${resolved.skill})`);
        try {
            (0,_sdk_runtimes_model_selectors_js__WEBPACK_IMPORTED_MODULE_3__/* .assertValidPiModelSelectors */ .lG)([resolved]);
            (0,_sdk_runtimes_custom_provider_js__WEBPACK_IMPORTED_MODULE_4__/* .assertCustomProviderAuthForRuntime */ .mN)(resolved.runtime, resolved.providers, process.env);
            ...
            const skill = await (0,_skills_loader_js__WEBPACK_IMPORTED_MODULE_7__/* .resolveSkillAsync */ .Cy)(resolved.skill, skillRoot, {
                remote: resolved.remote,
            });
            const runtimeEnv = await (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .prepareRuntimeEnvironment */ .bZ)([resolved], inputs);
            ...
            const issueResult = await (0,_output_github_issues_js__WEBPACK_IMPORTED_MODULE_5__/* .createOrUpdateIssue */ .w)(octokit, owner, repo, [report], {
                title: issueTitle,
                commitSha: headSha,
            });
            if (issueResult) {
            ...
            const reportForFail = { ...report, findings: (0,_types_index_js__WEBPACK_IMPORTED_MODULE_8__/* .filterFindings */ .Ni)(report.findings, undefined, resolved.minConfidence ?? 'medium') };
            if (failCheck && failOn && (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__/* .shouldFail */ .W9)(reportForFail, failOn)) {
                shouldFailAction = true;
                const count = (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__/* .countFindingsAtOrAbove */ .tH)(reportForFail, failOn);
                failureReasons.push(`${resolved.name}: Found ${count} ${failOn}+ severity issues`);
            }
            (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .logGroupEnd */ .TN)();
        }
        catch (error) {
            if (error instanceof _base_js__WEBPACK_IMPORTED_MODULE_10__/* .ActionFailedError */ .Ah)
                throw error;
    ...
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .handleTriggerErrors */ .a3)(triggerErrors, scheduleTriggers.length);
    // Set outputs
    const highCount = (0,_triggers_matcher_js__WEBPACK_IMPORTED_MODULE_6__/* .countSeverity */ .jC)(allReports, 'high');
    workflowSpan.setAttribute('warden.finding.count', totalFindings);
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('findings-count', totalFindings);
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('high-count', highCount);
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setOutput */ .uH)('summary', allReports.map((r) => r.summary).join('\n') || 'Scheduled analysis complete');
    // Write structured findings to file for external export (GCS, S3, etc.)
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .writeFindingsOutput */ .JR)(allReports, {
            eventType: 'schedule',
            action: 'scheduled',
    ...
    if (shouldFailAction) {
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .setFailed */ .C1)(failureReasons.join('; '));
    }
...
/* harmony export */   Zu: () => (/* reexport safe */ _utils_index_js__WEBPACK_IMPORTED_MODULE_6__.Zu),
...
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(36137);
/* harmony import */ var _model_lanes_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(22585);
...
function resolveSkillConfigs(config, cliModel, skillRootsByName) {
    ...
    const envModel = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(process.env['WARDEN_MODEL']);
    const result = [];
    ...
    const defaultAgentModel = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(defaults?.agent?.model) ??
        (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(defaults?.model) ??
        (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(cliModel) ??
        envModel;
    const { auxiliaryModel, synthesisModel } = (0,_model_lanes_js__WEBPACK_IMPORTED_MODULE_7__/* .resolveModelLanes */ .tP)({
    ...
    for (const skill of config.skills) {
        ...
        const baseModel = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(skill.model) ??
            (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(defaults?.agent?.model) ??
            (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(defaults?.model) ??
            (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_6__/* .emptyToUndefined */ .Zu)(cliModel) ??
            envModel;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Wy: () => (/* binding */ resolveAuxiliaryLaneModel),
/* harmony export */   tP: () => (/* binding */ resolveModelLanes)
/* harmony export */ });
/* unused harmony export resolveSynthesisLaneModel */
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36137);
/**
 ...
 */
function resolveAuxiliaryLaneModel(auxiliaryModel, defaultModel) {
    return (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* .emptyToUndefined */ .Zu)(auxiliaryModel) ?? (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* .emptyToUndefined */ .Zu)(defaultModel);
}
/**
 ...
 */
function resolveSynthesisLaneModel(synthesisModel, auxiliaryModel, defaultModel) {
    return ((0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* .emptyToUndefined */ .Zu)(synthesisModel) ??
 ...
 */
function resolveModelLanes(inputs) {
    const auxiliaryModel = resolveAuxiliaryLaneModel(inputs.auxiliaryModel, inputs.defaultModel);
    const synthesisModel = resolveSynthesisLaneModel(inputs.synthesisModel, inputs.auxiliaryModel, inputs.defaultModel);
...
const ProviderModelConfigSchema = schemas/* object */.Ik({
    /** Model id as exposed by the endpoint (e.g. the LiteLLM model name). */
    id: schemas/* string */.Yj().min(1),
    /** Display name. Defaults to `id`. */
    name: schemas/* string */.Yj().min(1).optional(),
    /** Whether the model supports reasoning/thinking. Default: false. */
    reasoning: schemas/* boolean */.zM().optional(),
    /** Accepted input modalities. Default: ["text"]. */
    input: schemas/* array */.YO(schemas/* enum */.k5(['text', 'image'])).min(1).optional(),
    /** Context window in tokens. Default: 128000. */
    contextWindow: schemas/* number */.ai().int().positive().optional(),
    /** Max output tokens. Default: 8192. */
    maxTokens: schemas/* number */.ai().int().positive().optional(),
    /** Per-token cost (USD per token). Default: all zeros. */
    cost: schemas/* object */.Ik({
        input: schemas/* number */.ai().nonnegative(),
        output: schemas/* number */.ai().nonnegative(),
        cacheRead: schemas/* number */.ai().nonnegative(),
        cacheWrite: schemas/* number */.ai().nonnegative(),
    }).optional(),
}).strict();
// A custom, self-hosted or gateway provider (e.g. LiteLLM). OpenAI-compatible only in v1.
const ProviderConfigSchema = schemas/* object */.Ik({
    /** OpenAI-compatible base URL, typically ending in /v1. */
    baseUrl: schemas/* string */.Yj().url(),
    /** Wire protocol. Only "openai-completions" is supported today. */
    api: schemas/* enum */.k5(['openai-completions']).default('openai-completions'),
    /** Extra HTTP headers sent on every request. */
    headers: schemas/* record */.g1(schemas/* string */.Yj(), schemas/* string */.Yj()).optional(),
    /** Env var holding the API key. Defaults to WARDEN_<NAME>_API_KEY then <NAME>_API_KEY. */
    apiKeyEnv: schemas/* string */.Yj().min(1).optional(),
    /** Models this provider exposes. At least one is required. */
    models: schemas/* array */.YO(ProviderModelConfigSchema).min(1),
}).strict();
// Map of provider name -> provider config. The name becomes the model-selector prefix.
const ProvidersConfigSchema = schemas/* record */.g1(schemas/* string */.Yj().min(1), ProviderConfigSchema);
...
Return [] if none are duplicates.`),
    ...
    const result = await (0,_sdk_runtimes_index_js__WEBPACK_IMPORTED_MODULE_2__/* .getRuntime */ .fr)(options.runtime ?? 'claude').runAuxiliary({
        ...
        providerOptions: (0,_sdk_runtimes_index_js__WEBPACK_IMPORTED_MODULE_2__/* .getRuntimeProviderOptions */ .g_)(options.runtime ?? 'claude', { providers: options.providers }),
    });
    if (!result.success) {
...
If no findings exist, return: {"findings": []}`),
    ...
    const result = await (0,_runtimes_index_js__WEBPACK_IMPORTED_MODULE_3__/* .getRuntime */ .fr)(runtimeName).runAuxiliary({
        ...
        maxRetries: options.maxRetries,
        providerOptions: (0,_runtimes_index_js__WEBPACK_IMPORTED_MODULE_3__/* .getRuntimeProviderOptions */ .g_)(runtimeName, { providers: options.providers }),
    });
    if (!result.success) {
        return {
            success: false,
...
Singletons should not appear. Return [] if no findings describe the same issue.`),
    ...
    const result = await (0,_runtimes_index_js__WEBPACK_IMPORTED_MODULE_3__/* .getRuntime */ .fr)(options?.runtime ?? 'claude').runSynthesis({
        ...
        maxTokens: 512,
        maxRetries: options?.maxRetries,
        providerOptions: (0,_runtimes_index_js__WEBPACK_IMPORTED_MODULE_3__/* .getRuntimeProviderOptions */ .g_)(options?.runtime ?? 'claude', { providers: options?.providers }),
    });
    if (!result.success) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RQ: () => (/* binding */ buildPiProviderOptions),
/* harmony export */   mN: () => (/* binding */ assertCustomProviderAuthForRuntime)
/* harmony export */ });
/* unused harmony exports resolveProviderApiKey, isLoopbackBaseUrl, assertCustomProviderAuth */
...
function resolveProviderApiKey(name, apiKeyEnv, env) {
...
function buildPiProviderOptions(providers, env) {
    if (!providers)
        return undefined;
    const entries = Object.entries(providers);
    if (entries.length === 0)
        return undefined;
    const built = entries.map(([name, config]) => ({
        name,
...
function assertCustomProviderAuth(options) {
    if (!options)
        return;
    for (const provider of options.providers) {
        if (!provider.apiKey && !isLoopbackBaseUrl(provider.baseUrl)) {
            throw new Error(`Custom provider "${provider.name}" has no API key. ` +
 ...
 */
function assertCustomProviderAuthForRuntime(runtime, providers, env) {
    if ((runtime ?? 'pi') !== 'pi')
        return;
