 ...
 */
export declare function createCompletedSkillCheck(octokit: Octokit, report: SkillReport, options: CreateCompletedSkillCheckOptions): Promise<CreateCheckResult>;
/**
 ...
 */
export declare function createFailedSkillCheck(octokit: Octokit, skillName: string, error: unknown, options: CheckOptions): Promise<CreateCheckResult>;
/**
 ...
 */
export declare function createCompletedCoreCheck(octokit: Octokit, summaryData: CoreCheckSummaryData, conclusion: CheckConclusion, options: CheckOptions): Promise<CreateCheckResult>;
/**
